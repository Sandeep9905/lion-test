        ...
        <>
            <div className='auth-form'>
                <div className="login-form">
                    <div className="login">
                        <h1 className="header-login">Signup to Our Lions club</h1>
                  ...
                  s2M7zQMBqJ+RaqqppppqqqmmmmqqqaaaairJ+h/KgxodrhNLaAAAAABJRU5ErkJggg==' alt="signup image" />
                        <form onSubmit={handleSubmit}>
                            <div class="mb-3">
                                <label for="formGroupExampleInput" class="form-label col-form-label-lg">Username</label>
                                <input
                                    type="text"
